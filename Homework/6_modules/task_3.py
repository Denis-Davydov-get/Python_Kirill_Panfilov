...
def generate_array_queens():
    '''
    Генерерует положение и количество ферзей на доске
    queens кол-во ферзей
    array_queens список с координатами фигур на доске
    '''
    array_queens = []
    array_queens.append((random.randint(1, 8), random.randint(1, 8)))
    return array_queens
